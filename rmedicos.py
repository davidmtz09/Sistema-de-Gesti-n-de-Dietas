...
def medicos():
    ...
    def load_data():
        ...
        path = Path.home() / "ContPerFactura" / "medicos.xlsx"
    ...
    def save_data():
        ...
        # Eliminar datos existentes, excepto el encabezado
    ...
    window = tk.Tk()
    window.title("Tabla de Medicos (MR/MIP)")
    ...
    for i, col in enumerate(cols):
        ...
        if i == len(cols) - 1:  # Last column for date range
            ...
            entry = ttk.Combobox(input_frame, values=["MR", "MIP"], width=5, state="readonly", name="tipo")
        else:
