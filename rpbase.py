...
def pbase():
    ...
    def load_data():
        ...
        path = Path.home() / "ContPerFactura" / "pbase.xlsx"
    ...
    for i, col in enumerate(cols):
        ...
        if i == len(cols) - 1:  # Last column for date range
            ...
            entry = ttk.Combobox(input_frame, values=["GAB", "GBB", "JADB", "JANB"], width=5, state="readonly", name="tipo")
        else:
