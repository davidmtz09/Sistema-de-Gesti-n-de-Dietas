...
def pcontrato():
    ...
    def load_data():
        ...
        path = Path.home() / "ContPerFactura" / "pcontrato.xlsx"
    ...
    window = tk.Tk()
    window.title("Personal de Contrato")
    ...
    for i, col in enumerate(cols):
        ...
        if i == len(cols) - 1:  # Last column for date range
            ...
            entry = ttk.Combobox(input_frame, values=["GAC", "GBC", "JADC","JANC"], width=5, state="readonly", name="tipo")
        else:
